...
// run this script with the command : `node populatedb`
...
const mongoDB = `mongodb+srv://${dbUserName}:${dbPassword}@cluster0.zwekp.mongodb.net/${dbName}?retryWrites=true&w=majority`;   
